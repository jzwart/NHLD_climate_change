fig_gpp_vol_resid_temp <- function(fig_ind, transparent, scenarios, drivers_file, fig_cfg_yml, remake_file, gd_config){
  ...
  p_e_gpp_vol_perc = ggplot(c_and_drivers, aes(x = p_e, y = delta_gpp_vol,
    ...
    geom_smooth(aes(x = p_e, y = delta_gpp_vol),
  ...
  ggsave(fig_file, plot=g, width = 11, height = 6)
