...
source('/Users/jzwart/NHLD_climate_change/R Code/AveLightClimate.R')
source('/Users/jzwart/NHLD_climate_change/R Code/DOY.r')
require(deSolve)
...
dir<-'/Users/jzwart/NHLD_climate_change/Data/Water/NHLD_Results_2017_11_29_CESM1_CAM5/'
...
# keeling<-read.table('/Users/jzwart/NHLD_climate_change/Data/Atm/keelingCurve.txt',sep=' ',header = F,stringsAsFactors = F)
...
keeling <- read.table(file.path('/Users/jzwart/NHLD_climate_change/Data/Atm/',paste('co2_',period,'.txt',sep='')),sep='\t',stringsAsFactors = F,header = T)
...
# for(i in 1:length(lakes)){
  ...
  k=0.5 # m day-1; initial gas exchange coefficient 
  ...
  # write.table(out,file.path(outDir,paste(lakes[i],"C_model.txt",sep="_")),row.names=FALSE,sep="\t",quote=F)
# }
